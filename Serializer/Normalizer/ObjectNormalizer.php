...
use Wearescytale\CompaniesHouseBundle\Model\Address;

/**
 * Class ObjectNormalizer
 *
 * TODO: Remove this class and use the symfony object normalizer with
 * a property type extractor when we drop support for symfony 2
 */
class ObjectNormalizer extends AbstractNormalizer
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $recursiveDenormalizationClasses = $this->getRecursiveDenormalizationMap();
        ...
        foreach ($normalizedData as $attribute => $value) {
            ...
            if ($allowed && !$ignored) {
                try {
                    ...
                    if (in_array($attribute, array_keys($recursiveDenormalizationClasses))) {
                        $attributeClass = $recursiveDenormalizationClasses[$attribute];
                        $value = $this->serializer->denormalize($value, $attributeClass);
                    }
     ...
     * @return array
     */
    private function getRecursiveDenormalizationMap()
    {
        return array(
